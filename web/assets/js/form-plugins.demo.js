...
var handleFormMaskedInput = function() {
    ...
    $("#truckLicExpired").mask("9999-99-99");
    $("#trailerLicExpired").mask("9999-99-99");
    $("#licDate").mask("9999-99-99");
};
...
var FormPlugins = function () {
    ...
    return {
        ...
        init: function () {
            ...
            //});
            //
            $.getScript('assets/plugins/masked-input/masked-input.js').done(function() {
            ...
            //});
            //
            $.getScript('assets/plugins/bootstrap-select/bootstrap-select.js').done(function() {
			    handleSelectpicker();
            });
